...
class BibTeXEntry(Entry):
    ...
    authors: Optional[Union[Union[dict, Person], list[Union[dict, Person]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.authors = [
            v if isinstance(v, Person) else Person(**as_dict(v)) for v in self.authors
        ]
...
class Citation(YAMLRoot):
    ...
    tags: Optional[
        Union[Union[str, "CitationTag"], list[Union[str, "CitationTag"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.tags = [
            v if isinstance(v, CitationTag) else CitationTag(v) for v in self.tags
        ]
...
class SoftwareComponent(YAMLRoot):
    ...
    description: Optional[str] = None
    version: Optional[str] = None
    citations: Optional[Union[Union[dict, Citation], list[Union[dict, Citation]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.citations = [
            v if isinstance(v, Citation) else Citation(**as_dict(v))
...
class DueCreditReport(YAMLRoot):
    ...
    description: Optional[str] = None
    entries: Optional[
        Union[dict[Union[str, EntryKey], Union[dict, Entry]], list[Union[dict, Entry]]]
    ] = empty_dict()
    citations: Optional[Union[Union[dict, Citation], list[Union[dict, Citation]]]] = (
        empty_list()
    )
    packages: Optional[
        Union[
            dict[Union[str, SoftwareComponentPath], Union[dict, SoftwareComponent]],
            list[Union[dict, SoftwareComponent]],
        ]
    ] = empty_dict()
    modules: Optional[
        Union[
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_list(
            slot_name="entries", slot_type=Entry, key_name="key", keyed=True
        )
...
class EntryType(EnumDefinitionImpl):
    ...
    bibtex = PermissibleValue(text="bibtex", description="A BibTeX formatted citation")
    doi = PermissibleValue(text="doi", description="A Digital Object Identifier")
    url = PermissibleValue(text="url", description="A URL reference")
    text = PermissibleValue(text="text", description="Free-form text citation")
...
class CitationTag(EnumDefinitionImpl):
    ...
    edu = PermissibleValue(
        text="edu", description="Tutorials, textbooks and other educational materials"
    )
    ...
    funding = PermissibleValue(
        text="funding", description="Sources of funding for the implementation"
    )
    dataset = PermissibleValue(text="dataset", description="References to datasets")
...
slots.person__given_name = Slot(
    uri=SCHEMA.givenName,
    name="person__given_name",
    curie=SCHEMA.curie("givenName"),
    model_uri=DUECREDIT.person__given_name,
    domain=None,
    range=Optional[str],
)

slots.person__family_name = Slot(
    uri=SCHEMA.familyName,
    name="person__family_name",
    curie=SCHEMA.curie("familyName"),
    model_uri=DUECREDIT.person__family_name,
    domain=None,
    range=Optional[str],
)
...
slots.person__name = Slot(
    ...
    model_uri=DUECREDIT.person__name,
    domain=None,
    range=Optional[str],
)
...
slots.person__email = Slot(
    ...
    model_uri=DUECREDIT.person__email,
    domain=None,
    range=Optional[str],
)

slots.person__orcid = Slot(
    uri=SCHEMA.identifier,
    name="person__orcid",
    curie=SCHEMA.curie("identifier"),
    model_uri=DUECREDIT.person__orcid,
    domain=None,
    range=Optional[str],
)

slots.person__affiliation = Slot(
    uri=SCHEMA.affiliation,
    name="person__affiliation",
    curie=SCHEMA.curie("affiliation"),
    model_uri=DUECREDIT.person__affiliation,
    domain=None,
    range=Optional[str],
)

slots.entry__key = Slot(
    uri=DUECREDIT.key,
    name="entry__key",
    curie=DUECREDIT.curie("key"),
    model_uri=DUECREDIT.entry__key,
    domain=None,
    range=URIRef,
)

slots.entry__entry_type = Slot(
    uri=DUECREDIT.entry_type,
    name="entry__entry_type",
    curie=DUECREDIT.curie("entry_type"),
    model_uri=DUECREDIT.entry__entry_type,
    domain=None,
    range=Union[str, "EntryType"],
)

slots.entry__raw_entry = Slot(
    uri=DUECREDIT.raw_entry,
    name="entry__raw_entry",
    curie=DUECREDIT.curie("raw_entry"),
    model_uri=DUECREDIT.entry__raw_entry,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__bibtex_type = Slot(
    uri=DUECREDIT.bibtex_type,
    name="bibTeXEntry__bibtex_type",
    curie=DUECREDIT.curie("bibtex_type"),
    model_uri=DUECREDIT.bibTeXEntry__bibtex_type,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__title = Slot(
    uri=SCHEMA.name,
    name="bibTeXEntry__title",
    curie=SCHEMA.curie("name"),
    model_uri=DUECREDIT.bibTeXEntry__title,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__authors = Slot(
    uri=SCHEMA.author,
    name="bibTeXEntry__authors",
    curie=SCHEMA.curie("author"),
    model_uri=DUECREDIT.bibTeXEntry__authors,
    domain=None,
    range=Optional[Union[Union[dict, Person], list[Union[dict, Person]]]],
)

slots.bibTeXEntry__year = Slot(
    uri=SCHEMA.datePublished,
    name="bibTeXEntry__year",
    curie=SCHEMA.curie("datePublished"),
    model_uri=DUECREDIT.bibTeXEntry__year,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__journal = Slot(
    uri=SCHEMA.isPartOf,
    name="bibTeXEntry__journal",
    curie=SCHEMA.curie("isPartOf"),
    model_uri=DUECREDIT.bibTeXEntry__journal,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__volume = Slot(
    uri=DUECREDIT.volume,
    name="bibTeXEntry__volume",
    curie=DUECREDIT.curie("volume"),
    model_uri=DUECREDIT.bibTeXEntry__volume,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__number = Slot(
    uri=DUECREDIT.number,
    name="bibTeXEntry__number",
    curie=DUECREDIT.curie("number"),
    model_uri=DUECREDIT.bibTeXEntry__number,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__pages = Slot(
    uri=SCHEMA.pagination,
    name="bibTeXEntry__pages",
    curie=SCHEMA.curie("pagination"),
    model_uri=DUECREDIT.bibTeXEntry__pages,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__publisher = Slot(
    uri=SCHEMA.publisher,
    name="bibTeXEntry__publisher",
    curie=SCHEMA.curie("publisher"),
    model_uri=DUECREDIT.bibTeXEntry__publisher,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__doi = Slot(
    uri=SCHEMA.identifier,
    name="bibTeXEntry__doi",
    curie=SCHEMA.curie("identifier"),
    model_uri=DUECREDIT.bibTeXEntry__doi,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__url = Slot(
    uri=SCHEMA.url,
    name="bibTeXEntry__url",
    curie=SCHEMA.curie("url"),
    model_uri=DUECREDIT.bibTeXEntry__url,
    domain=None,
    range=Optional[str],
)

slots.bibTeXEntry__abstract = Slot(
    uri=SCHEMA.abstract,
    name="bibTeXEntry__abstract",
    curie=SCHEMA.curie("abstract"),
    model_uri=DUECREDIT.bibTeXEntry__abstract,
    domain=None,
    range=Optional[str],
)

slots.doiEntry__doi = Slot(
    uri=SCHEMA.identifier,
    name="doiEntry__doi",
    curie=SCHEMA.curie("identifier"),
    model_uri=DUECREDIT.doiEntry__doi,
    domain=None,
    range=str,
)

slots.urlEntry__url = Slot(
    uri=SCHEMA.url,
    name="urlEntry__url",
    curie=SCHEMA.curie("url"),
    model_uri=DUECREDIT.urlEntry__url,
    domain=None,
    range=str,
)

slots.textEntry__text = Slot(
    uri=DUECREDIT.text,
    name="textEntry__text",
    curie=DUECREDIT.curie("text"),
    model_uri=DUECREDIT.textEntry__text,
    domain=None,
    range=str,
)

slots.citation__entry_key = Slot(
    uri=DUECREDIT.entry_key,
    name="citation__entry_key",
    curie=DUECREDIT.curie("entry_key"),
    model_uri=DUECREDIT.citation__entry_key,
    domain=None,
    range=str,
)

slots.citation__path = Slot(
    uri=CODEMETA.targetProduct,
    name="citation__path",
    curie=CODEMETA.curie("targetProduct"),
    model_uri=DUECREDIT.citation__path,
    domain=None,
    range=str,
)

slots.citation__description = Slot(
    uri=SCHEMA.description,
    name="citation__description",
    curie=SCHEMA.curie("description"),
    model_uri=DUECREDIT.citation__description,
    domain=None,
    range=Optional[str],
)

slots.citation__version = Slot(
    uri=SCHEMA.softwareVersion,
    name="citation__version",
    curie=SCHEMA.curie("softwareVersion"),
    model_uri=DUECREDIT.citation__version,
    domain=None,
    range=Optional[str],
)

slots.citation__tags = Slot(
    uri=DUECREDIT.tags,
    name="citation__tags",
    curie=DUECREDIT.curie("tags"),
    model_uri=DUECREDIT.citation__tags,
    domain=None,
    range=Optional[Union[Union[str, "CitationTag"], list[Union[str, "CitationTag"]]]],
)

slots.citation__cite_module = Slot(
    uri=DUECREDIT.cite_module,
    name="citation__cite_module",
    curie=DUECREDIT.curie("cite_module"),
    model_uri=DUECREDIT.citation__cite_module,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.citation__count = Slot(
    uri=DUECREDIT.count,
    name="citation__count",
    curie=DUECREDIT.curie("count"),
    model_uri=DUECREDIT.citation__count,
    domain=None,
    range=Optional[int],
)

slots.softwareComponent__path = Slot(
    uri=SCHEMA.identifier,
    name="softwareComponent__path",
    curie=SCHEMA.curie("identifier"),
    model_uri=DUECREDIT.softwareComponent__path,
    domain=None,
    range=URIRef,
)

slots.softwareComponent__name = Slot(
    uri=SCHEMA.name,
    name="softwareComponent__name",
    curie=SCHEMA.curie("name"),
    model_uri=DUECREDIT.softwareComponent__name,
    domain=None,
    range=Optional[str],
)

slots.softwareComponent__description = Slot(
    uri=SCHEMA.description,
    name="softwareComponent__description",
    curie=SCHEMA.curie("description"),
    model_uri=DUECREDIT.softwareComponent__description,
    domain=None,
    range=Optional[str],
)

slots.softwareComponent__version = Slot(
    uri=SCHEMA.softwareVersion,
    name="softwareComponent__version",
    curie=SCHEMA.curie("softwareVersion"),
    model_uri=DUECREDIT.softwareComponent__version,
    domain=None,
    range=Optional[str],
)

slots.softwareComponent__citations = Slot(
    uri=DUECREDIT.citations,
    name="softwareComponent__citations",
    curie=DUECREDIT.curie("citations"),
    model_uri=DUECREDIT.softwareComponent__citations,
    domain=None,
    range=Optional[Union[Union[dict, Citation], list[Union[dict, Citation]]]],
)

slots.dueCreditReport__name = Slot(
    uri=SCHEMA.name,
    name="dueCreditReport__name",
    curie=SCHEMA.curie("name"),
    model_uri=DUECREDIT.dueCreditReport__name,
    domain=None,
    range=Optional[str],
)

slots.dueCreditReport__version = Slot(
    uri=SCHEMA.softwareVersion,
    name="dueCreditReport__version",
    curie=SCHEMA.curie("softwareVersion"),
    model_uri=DUECREDIT.dueCreditReport__version,
    domain=None,
    range=Optional[str],
)

slots.dueCreditReport__description = Slot(
    uri=SCHEMA.description,
    name="dueCreditReport__description",
    curie=SCHEMA.curie("description"),
    model_uri=DUECREDIT.dueCreditReport__description,
    domain=None,
    range=Optional[str],
)

slots.dueCreditReport__entries = Slot(
    uri=DUECREDIT.entries,
    name="dueCreditReport__entries",
    curie=DUECREDIT.curie("entries"),
    model_uri=DUECREDIT.dueCreditReport__entries,
    domain=None,
    range=Optional[
        Union[dict[Union[str, EntryKey], Union[dict, Entry]], list[Union[dict, Entry]]]
    ],
...
slots.dueCreditReport__citations = Slot(
    uri=DUECREDIT.citations,
    name="dueCreditReport__citations",
    curie=DUECREDIT.curie("citations"),
    model_uri=DUECREDIT.dueCreditReport__citations,
    domain=None,
    range=Optional[Union[Union[dict, Citation], list[Union[dict, Citation]]]],
)

slots.dueCreditReport__packages = Slot(
    uri=DUECREDIT.packages,
    name="dueCreditReport__packages",
    curie=DUECREDIT.curie("packages"),
    model_uri=DUECREDIT.dueCreditReport__packages,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, SoftwareComponentPath], Union[dict, SoftwareComponent]],
...
slots.dueCreditReport__modules = Slot(
    uri=DUECREDIT.modules,
    name="dueCreditReport__modules",
    curie=DUECREDIT.curie("modules"),
    model_uri=DUECREDIT.dueCreditReport__modules,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, SoftwareComponentPath], Union[dict, SoftwareComponent]],
...
slots.dueCreditReport__functions = Slot(
    uri=DUECREDIT.functions,
    name="dueCreditReport__functions",
    curie=DUECREDIT.curie("functions"),
    model_uri=DUECREDIT.dueCreditReport__functions,
    domain=None,
    range=Optional[
        Union[
            dict[Union[str, SoftwareComponentPath], Union[dict, SoftwareComponent]],
